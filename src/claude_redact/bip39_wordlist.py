...
Used by detection.py to validate that a candidate 12/24-word run is a
real mnemonic (not just any English prose) and by generators.py to mint
a same-length replacement phrase from the same vocabulary.
"""
from __future__ import annotations

BIP39_WORDLIST: tuple[str, ...] = (
...
BIP39_WORDS: frozenset[str] = frozenset(BIP39_WORDLIST)
