...
from claude_proxy.logging_config import configure as _configure_logging  # noqa: E402

_configure_logging()

from claude_proxy.app import app  # noqa: E402  — depends on env + logging setup above
